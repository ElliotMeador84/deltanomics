...
Creating a new dataset is also a useful learning opportunity because we will *reverse engineer* a dataset around specific modelling, correlations and otherwise interesting easter-eggs that we find interesting. 
...
A common question in network analysis is: do nodes behaviour differently when they are connected to certain nodes. It's like the old adage ~ *if you lie down with dogs you'll get up with fleas*. For this, we'll pick out some random nodes and have their neighbourhoods adopt a similar value for a question like: do you buy the majority of your fruit and veg from a farmers market?
